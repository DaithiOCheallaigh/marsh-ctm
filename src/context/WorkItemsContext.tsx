    ...
    leaverReassignments: [
      {
        id: 'lr_001',
        clientId: 'lc_001',
        clientName: 'The Palms South Properties',
        industry: 'Corporate',
        reassignedToId: 'rtm_001',
        reassignedToName: 'Sarah Anderson',
        role: 'Senior Account Manager',
        location: 'Chicago',
        capacityRequirement: 1.0,
      },
      {
        id: 'lr_002',
        clientId: 'lc_002',
        clientName: 'Scout Healthcare',
        industry: 'Healthcare',
        reassignedToId: 'rtm_002',
        reassignedToName: 'Michael Chen',
        role: 'Compliance Officer',
        location: 'New York',
        capacityRequirement: 0.5,
      },
      {
        id: 'lr_003',
        clientId: 'lc_003',
        clientName: 'Easy Post',
        industry: 'Government',
        reassignedToId: 'rtm_003',
        reassignedToName: 'Louis Jones',
      ...
      },
      {
        ...
        industry: 'Corporate',
        reassignedToId: 'rtm_005',
        reassignedToName: 'Ivy Thomas',
